...
<body>
    <table style="vertical-align: top; width: 100%;">
        ...
        <tr style="text-align: center">
            <td class="caption" style="text-align: center;">ระบบได้จัดส่งรหัสผ่านไปที่อีเมล์ที่ระบุไว้แล้ว</td>
        </tr>

        <tr style="text-align: center">
            <td style="text-align: center;">
                <input type="button" id="accept" class="button" value="ถัดไป" onclick="window.open('index','_self')">
            </td>
        </tr>
    </table>
</body>
