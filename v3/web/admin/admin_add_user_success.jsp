...
<form id="admin_add_user_success_form" action="" method="post">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td class="normal_text" style="font-size: 2em; text-align: left;" colspan="2">ยินดีต้อนรับ</td>
        </tr>
        <tr class="menu_dot">
        ...
        <tr style="border-color: #dcac4e">
            <td colspan="2">
                <table style="vertical-align: top; width: 100%; border: 1px dotted #dcac4e; border-spacing: 5px;">
                    ...
                    <tr>
                        <td class="caption" colspan="4" style="text-align:center; color: #e7daa6;"><i class="fa fa-check-circle-o fa-6x" style="color:#e7daa6;"></i></td>
                    </tr>
                    <tr>
                        <td class="caption" colspan="4" style="text-align:center; color: #e7daa6;"><span style="font-size: 3em; color: #e7daa6;">สมัครสมาชิกสำเร็จ</span></td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: center; font-size: large; color: #dcac4e;" class="text_header" colspan="4">นโยบายของ web&nbsp;&nbsp;&nbsp;กฎกติกามารยาท</td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: center; font-size: x-large" class="text_header" colspan="4">
                            <span class="button" style="width: 10%; display: block; text-align: center; position: absolute; left:45%" onclick="window.open('admaddusrpage','_self')">ต่อไป</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: left; font-size: x-large" class="text_header" colspan="2">&nbsp;</td>
