...
<head>
    ...
    <title>ผู้ดูแลระบบ::สมัครสมาชิก</title>
    <script>
    </script>
</head>
<body>
<form id="admin_add_user_success_form" action="" method="post">
    <table width="100%" border="0">
        <tr>
            <td class="normal_text" style="font-size: 2em; color: #e7daa6; text-align: left;" colspan="2">ยินดีต้อนรับ</td>
        </tr>
        <tr class="menu_dot">
        ...
        <tr style="border-color: #dcac4e">
            <td colspan="2">
                <table style="vertical-align: top; width: 100%; border: 1px dotted #dcac4e; border-spacing: 5px;">
                    ...
                    <tr>
                        <td class="caption" colspan="4" style="text-align:center;"><i class="fa fa-check-circle-o fa-6x" style="color:#e7daa6;"></i></td>
                    </tr>
                    <tr>
                        <td class="caption" colspan="4" style="text-align:center;"><span style="font-size: 3em; color: #e7daa6;">สมัครสมาชิกสำเร็จ</span></td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: center; font-size: large; color: #f2f2f2;" class="text_header" colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: center; font-size: x-large" class="text_header" colspan="4">
                            <span class="button" style="width: 10%; text-align: center; left:45%;" onclick="window.open('index','_self')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ต่อไป&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: left; font-size: x-large" class="text_header" colspan="2">&nbsp;</td>
