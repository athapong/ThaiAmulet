...
<form name="policy_form">
    <table width="100%" border="0">
        <jsp:include page="./exclusive/ex_menu.jsp?tab=3"/>
        <tr>
            <td class="normal_text" style="font-size: 2em; text-align: left;" colspan="3">ดูนโยบายของ web</td>
        </tr>
        <tr class="menu_dot">
