...
<head>
    ...
    <title>Exclusive::ค้นหาข้อมูลพระเครื่อง</title>
</head>
...
<form id="ex_inq_amulet_form" action="ExDoInquiryAmuletServlet" method="post" style="text-align:center;">
    ...
    <table width="100%" border="0">
        ...
        <tr style="vertical-align: middle">
            <td class="caption" style="padding-bottom: 10px; color: #f2d576; font-size: 1em; text-align: left;" colspan="3"><label style="font-size: 1.5em;">ค้นหาข้อมูลพระเครื่อง</label></td>
        </tr>
            ...
            <td colspan="3">
                <table style="vertical-align: top; width: 100%; border: 1px dotted #dcac4e; border-spacing: 5px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 10%;"><input type="number" id="year_from" name="year_from" style="width: 150px;" maxlength="4" value="<%=formBean.getYEAR_FROM()%>"/></td>
                        <td class="caption" style="width: 10%;">ถึง พ.ศ.</td>
                        <td style="width: 10%;"><input type="number" id="year_to" name="year_to" style="width: 150px;" maxlength="4" value="<%=formBean.getYEAR_TO()%>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%;"><input type="number" id="meditaion_l" name="mediation_l" style="width:150px;" value="<%=formBean.getMEDITATION_L() == null ? "" : formBean.getMEDITATION_L()%>"/>&nbsp;<label class="caption"> ซม.</label></td>
                        <td class="caption" style="width: 10%;">&nbsp;</td>
                        <td style="width: 10%;">&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="caption" style="width: 10%;">ราคาตั้งแต่</td>
                        <td style="width: 10%;"><input type="number" id="price_from" name="price_from" style="width:150px;" value="<%=formBean.getPRICE_FROM() == null ? "" : formBean.getPRICE_FROM()%>"/></td>
                        <td class="caption" style="width: 10%;">ถึง</td>
                        <td style="width: 10%;"><input type="number" id="price_to" name="price_to" style="width:150px;" value="<%=formBean.getPRICE_TO() == null ? "" : formBean.getPRICE_TO()%>"/></td>
                    </tr>
                </table>
            </td>
        </tr>
