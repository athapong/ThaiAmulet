...
<head>
    ...
    <title>ผู้ดูแลระบบ::เข้าระบบไม่สำเร็จ</title>
    <script>
    </script>
</head>
<body>
        ...
        <tr style="border-color: #dcac4e">
            <td colspan="2">
                <table style="vertical-align: top; width: 100%; border: 1px dotted #dcac4e; border-spacing: 5px;">
                    ...
                    <tr>
                        <td class="caption" colspan="4" style="text-align:center;"><span style="font-size: 3em; color: #ff1d25;">username หรือ password ไม่ถูกต้อง</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width:30%;text-align: center; font-size: x-large" class="text_header" colspan="4">
                            <span class="button" style="width: 10%; text-align: center;" onclick="history.go(-1)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;กลับ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: left; font-size: x-large" class="text_header" colspan="2">&nbsp;</td>
